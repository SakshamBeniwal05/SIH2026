...
export function LeftDrawer({ isCollapsed = false, onToggleCollapse }) {
            ...
            {reports.map((report) => (
              <div
                ...
                className={`p-2.5 border transition-all ${
                  isDark
                    ? 'bg-[#181c23] border-[#27303e] hover:border-[#D32F2F]'
              ...
              >
                ...
                <div className="flex items-center justify-between mb-1.5">
                  <div className="flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-none bg-[#D32F2F]" />
                ...
                {/* Footer Coordinates & Agent Status */}
                <div className="flex items-center justify-between font-telemetry text-[10px] text-slate-400 pt-1.5 border-t border-slate-800">
                  <span>
                    GRID: {report.location?.coordinates ? `${report.location.coordinates[1].toFixed(3)}°N, ${report.location.coordinates[0].toFixed(3)}°E` : '25.582°N, 91.884°E'}
                  </span>
                  <span className={report.agentEvaluated ? 'text-[#00E676] font-semibold' : 'text-amber-400'}>
                    {report.agentEvaluated ? 'AI VERIFIED' : 'QUEUED'}
                  </span>
                </div>
              </div>
            ))}
        ...
        {activeTab === 'layers' && (
          <div className="p-3 border space-y-3 font-body text-xs">
            ...
            <div className="space-y-2">
              ...
              <label className="flex items-center justify-between">
                <span>Doppler Radar Cloudburst Inflow</span>
